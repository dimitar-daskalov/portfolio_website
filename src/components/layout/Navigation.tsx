...
const Navigation = () => {
  ...
  return (
    <nav className="fixed flex flex-col items-center xl:justify-center gap-y-4 h-max bottom-8 xl:bottom-0 mt-auto xl:right-[1%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen">
      <LanguageSwitcher />
      <SwitchThemeToggle />
      <Socials />
      <div className="flex w-full xl:flex-col items-center justify-between xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0 h-20 xl:h-max py-8 bg-accent-2/10 backdrop-blur-sm text-3xl xl:text-xl xl:rounded-full">
